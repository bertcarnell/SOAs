...
test_that("soacheck2D", {
  ...
  expect_snapshot_output(expect_false(soacheck2D(nullcase, s=2, el=3, t=4, verbose=TRUE)))
  expect_false(soacheck2D(nullcase, s=2, el=3, t=3, verbose=TRUE))
  expect_false(soacheck2D(nullcase4, s=2, el=2, t=3, verbose=TRUE))
