...
#'
#' @details
#' The construction is implemented as described in Groemping (2023).
#'
...
#' strength 3+. Furthermore, Groemping (2023) proposed an improved choice of columns
