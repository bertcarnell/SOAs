...
#'
#' Groemping, U. (2023). A unifying implementation of stratum (aka strong) orthogonal arrays. To appear in \emph{Computational Statistics and Data Analysis}. \doi{10.1016/j.csda.2023.107739}
#'
